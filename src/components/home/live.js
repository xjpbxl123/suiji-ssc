(function (global, factory) {
	...
	var _ie8DomDefine = !require$$0$2 && !require$$0(function () {
	...
	var $export = function (type, name, source) {
	  ...
	  var target = IS_GLOBAL ? require$$0$1 : IS_STATIC ? require$$0$1[name] : (require$$0$1[name] || {})[PROTOTYPE];
	  var key, own, out;
	  ...
	  for (key in source) {
	    ...
	    : IS_BIND && own ? ctx(out, require$$0$1)
	...
	require$$0$3(IteratorPrototype, require$$1$2('iterator'), function () { return this; });
	...
	var require$$0$9 = ( _iterDetect$1 && _iterDetect ) || _iterDetect$1;

	$export$1($export$1.S + $export$1.F * !require$$0$9(function (iter) { }), 'Array', {
	...
	var require$$0$10 = ( from$1 && from ) || from$1;
	...
	var _redefineAll = function (target, src, safe) {
	  for (var key in src) {
	    ...
	    else require$$0$3(target, key, src[key]);
	  } return target;
	};
	...
	var _setSpecies = function (KEY) {
	  var C = typeof require$$1$1[KEY] == 'function' ? require$$1$1[KEY] : require$$0$1[KEY];
	...
	$export$1($export$1.S + $export$1.F * !(USE_NATIVE && require$$0$9(function (iter) {
	...
	$export$1($export$1.P + $export$1.R, 'Promise', { 'finally': function (onFinally) {
	  var C = speciesConstructor(this, require$$1$1.Promise || require$$0$1.Promise);
	...
	var require$$0$15 = ( isIterable$1 && isIterable ) || isIterable$1;
	...
	var require$$0$16 = ( getIterator$1 && getIterator ) || getIterator$1;
	...
	var require$$0$17 = ( _objectToArray$1 && _objectToArray ) || _objectToArray$1;

	// https://github.com/tc39/proposal-object-values-entries

	var $entries = require$$0$17(true);
	...
	var require$$0$18 = ( entries$1 && entries ) || entries$1;
	...
	var require$$0$19 = ( defineProperty$1 && defineProperty ) || defineProperty$1;
	...
	var require$$0$20 = ( _objectAssign$1 && _objectAssign ) || _objectAssign$1;

	// 19.1.3.1 Object.assign(target, source)


	$export$1($export$1.S + $export$1.F, 'Object', { assign: require$$0$20 });
	...
	var require$$0$21 = ( assign$1 && assign ) || assign$1;
	...
	LAppModel.prototype.update = function () {
	  ...
	  if (this.mainMotionManager.isFinished()) {
	    ...
	    //   this.startRandomMotion(this.userRandomMotionType, this.userRandomMotion_PRIORITY)
	...
	LAppModel.prototype.startMotion = function (name, no, priority, resolve) {
	  ...
	  if (this.motions[name] == null) {
	    this.loadMotion(null, this.modelHomeDir + motionName, function (mtn) {
	      ...
	      thisRef.setFadeInFadeOut(name, no, priority, motion, resolve);
	    });
	  } else {
	...
	LAppModel.prototype.setFadeInFadeOut = function (name, no, priority, motion, resolve) {
	  var motionName = this.modelSetting.getMotionFile(name, no);
	  ...
	  if (this.modelSetting.getMotionSound(name, no) == null) {
	    ...
	    this.startMotionCallBack = resolve;
	  } else {
	    // 传入自己的sound资源路径
	    if (this.UserclassModel.isHasOwnSound) {
	      this.UserclassModel.startSound();
	...
	LAppLive2DManager.prototype.loadModel = function (gl, modelJsonFile, callback) {
	...
	*/
	...
	/**
	 * @class CreateScene
	 * @param {String} canvansId
	 */

	var CreateScene = function () {
	  function CreateScene() {
	    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	        _ref$canvansId = _ref.canvansId,
	        canvansId = _ref$canvansId === undefined ? false : _ref$canvansId,
	  ...
	  _createClass(CreateScene, [{
	    ...
	    key: 'getError',
	    value: function getError(canvansId) {
	      if (canvansId === false) {
	        return true;
	      }
	    }
	    ...
	    value: function startDraw() {
	      ...
	      (function tick() {
	        thisUser.draw();
	        thisUser.user_animationId = requestAnimationFrame(tick, thisUser.canvas);
	      })();
	    }
	  }, {
	    key: 'modelName',
	    ...
	    value: function move() {
	      ...
	      var _ref5 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          _ref5$x = _ref5.x,
	          x = _ref5$x === undefined ? false : _ref5$x,
	          _ref5$y = _ref5.y,
	          y = _ref5$y === undefined ? false : _ref5$y,
	          _ref5$time = _ref5.time,
	          time = _ref5$time === undefined ? '500ms' : _ref5$time;
	      ...
	      return new _Promise(function (resolve, reject) {
	        ...
	        _this2.canvas.style.transition = 'all ' + time + ' linear';
	        _this2.setCanvasStyle({ left: x + 'px', top: y + 'px' });
	        var fn = function fn(e) {
	          _this2.canvas.removeEventListener('transitionend', fn);
	    ...
	    value: function addCanvasEvent() {
	      var _ref6 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          ...
	          event = _ref6$event === undefined ? 'click' : _ref6$event,
	          _ref6$func = _ref6.func,
	          func = _ref6$func === undefined ? function () {} : _ref6$func;

	      this.canvas.addEventListener(event, func);
	    }
	  }, {
	    key: 'getChongHui',
	    value: function getChongHui(property) {
	      if (window.getComputedStyle(this.moveDom, null)[property]) {
	    ...
	    value: function appear() {
	      ...
	      var _ref7 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          _ref7$startX = _ref7.startX,
	          startX = _ref7$startX === undefined ? 0 : _ref7$startX,
	          _ref7$startY = _ref7.startY,
	          startY = _ref7$startY === undefined ? 0 : _ref7$startY,
	          _ref7$endX = _ref7.endX,
	          endX = _ref7$endX === undefined ? startX : _ref7$endX,
	          _ref7$endY = _ref7.endY,
	          endY = _ref7$endY === undefined ? startY : _ref7$endY,
	          _ref7$startOpacity = _ref7.startOpacity,
	          startOpacity = _ref7$startOpacity === undefined ? 0 : _ref7$startOpacity,
	          _ref7$time = _ref7.time,
	          time = _ref7$time === undefined ? '500ms' : _ref7$time,
	          _ref7$animation = _ref7.animation,
	          animation = _ref7$animation === undefined ? false : _ref7$animation;
	    ...
	    value: function setCanvasStyle(objStyle) {
	      ...
	      _Object$entries(objStyle).forEach(function (_ref8) {
	    ...
	    value: function disappear() {
	      ...
	      var _ref10 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          ...
	          time = _ref10$time === undefined ? '500ms' : _ref10$time,
	          _ref10$opacity = _ref10.opacity,
	          opacity = _ref10$opacity === undefined ? 0 : _ref10$opacity,
	          _ref10$animation = _ref10.animation,
	          animation = _ref10$animation === undefined ? false : _ref10$animation;
	    ...
	    value: function animation() {
	      ...
	      return new _Promise(function (resolve, reject) {
	        ...
	        var obj = {};
	        _Object$entries(_arguments[0]).forEach(function (_ref12) {
	...
	var Model = function () {
	  function Model(configUrl, that, callBack) {
	  ...
	  _createClass(Model, [{
	    ...
	    value: function startMotion() {
	      ...
	      var _ref14 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          ...
	          name = _ref14$name === undefined ? 'idle' : _ref14$name,
	          _ref14$id = _ref14.id,
	          id = _ref14$id === undefined ? 0 : _ref14$id,
	          _ref14$sound = _ref14.sound,
	          sound = _ref14$sound === undefined ? false : _ref14$sound;

	      if (sound !== false) {
	        this.isHasOwnSound = true;
	        this.ownSoundUrl = sound;
	      }
	      return new _Promise(function (resolve, reject) {
	        _this7.model.startMotion(name, id, undefined, resolve);
	      });
	    }
	  }, {
	    key: 'stopMotion',
	    ...
	    value: function startExpress() {
	      ...
	      var _ref15 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          ...
	          name = _ref15$name === undefined ? 'expressName' : _ref15$name;
	    ...
	    value: function startPose() {
	      ...
	      var _ref16 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          _ref16$pose = _ref16.pose,
	          pose = _ref16$pose === undefined ? '' : _ref16$pose;
	    ...
	    value: function scale() {
	      ...
	      var _ref17 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          ...
	          _scale = _ref17$scale === undefined ? 1 : _ref17$scale;
	    ...
	    value: function replacePart() {
	      ...
	      var _ref18 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          _ref18$picArr = _ref18.picArr,
	          picArr = _ref18$picArr === undefined ? [] : _ref18$picArr,
	          _ref18$load = _ref18.load,
	          load = _ref18$load === undefined ? false : _ref18$load;
	    ...
	    value: function animations() {
	      ...
	      var _ref19 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          _ref19$sound = _ref19.sound,
	          sound = _ref19$sound === undefined ? false : _ref19$sound,
	          _ref19$pose = _ref19.pose,
	          _ref19$scale = _ref19.scale,
	          _ref19$startExpress = _ref19.startExpress,
	          _ref19$startMotion = _ref19.startMotion;

	      var obj = {};
	      var arr = [];
	      _Object$entries(arguments[0]).forEach(function (_ref20) {
	      ...
	      if (obj.hasOwnProperty('sound') && obj.hasOwnProperty('startMotion')) {
	        this.isHasOwnSound = true;
	        this.ownSoundUrl = sound;
	      }
	      _Object$entries(obj).forEach(function (_ref22) {
	    ...
	    value: function mouseSpeak() {
	      ...
	      var _ref25 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          _ref25$soundUrl = _ref25.soundUrl,
	          soundUrl = _ref25$soundUrl === undefined ? false : _ref25$soundUrl,
	          _ref25$mouseSpeed = _ref25.mouseSpeed,
	          mouseSpeed = _ref25$mouseSpeed === undefined ? 5 : _ref25$mouseSpeed;
	...
	var FindLive2D = function () {
	  ...
	  _createClass(FindLive2D, null, [{
	    ...
	    value: function install(Vue, options) {
	      ...
	      Vue.component(commentsCanvas.name, commentsCanvas.component);
	    }
	  }]);
