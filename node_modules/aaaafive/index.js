(function (global, factory) {
	...
	var require$$0$11 = ( _stringAt$1 && _stringAt ) || _stringAt$1;

	var require$$0$12 = ( _iterDefine$1 && _iterDefine ) || _iterDefine$1;

	var $at = require$$0$11(true);

	// 21.1.3.27 String.prototype[@@iterator]()
	require$$0$12(String, 'String', function (iterated) {
	...
	var require$$0$13 = ( _iterDetect$1 && _iterDetect ) || _iterDetect$1;

	$export$1($export$1.S + $export$1.F * !require$$0$13(function (iter) { }), 'Array', {
	...
	var require$$0$14 = ( from$1 && from ) || from$1;
	...
	var es6_array_iterator = require$$0$12(Array, 'Array', function (iterated, kind) {
	...
	$export$1($export$1.S + $export$1.F * !(USE_NATIVE && require$$0$13(function (iter) {
	...
	var require$$0$20 = ( promise$1 && promise ) || promise$1;
	...
	ModelSettingJson.prototype.getTextNum = function (name) {
	  if (this.json[this.TEXT_GROUPS] == null || this.json[this.TEXT_GROUPS][name] == null) {
	    return 0;
	  }

	  return this.json[this.TEXT_GROUPS][name].length;
	};
	...
	_Object$assign(LAppModel.prototype, {
	  ...
	  userTextRandom: function userTextRandom(type) {
	    // let max = this.modelSetting.getTextNum(type)
	    // if (max / 1 === 0) return
	...
	LAppModel.prototype.update = function () {
	  ...
	  if (this.mainMotionManager.isFinished()) {
	    ...
	    if (isFunction_1(this.startMotionCallBack)) {
	      console.log('isFinished---startMotionCallBack');
	      this.startMotionCallBack(this.UserclassModel);
	      this.startMotionCallBack = null;
	    } else {
	      //   console.log('startRandomMotion')
	      //   this.userTextRandom(this.userTextRandomType)
	      console.log('startRandomMotion--', this.userRandomMotionType);
	...
	LAppModel.prototype.setFadeInFadeOut = function (name, no, priority, motion, resolve, newMotionManager) {
	  ...
	  if (this.UserclassModel.isHasOwnSound) {
	    this.UserclassModel.startSound(function () {
	      motionManger.startMotionPrio(motion, priority);
	      _this5.startMotionCallBack = newMotionManager.isTrue === true ? null : resolve;
	      if (newMotionManager.isTrue === true) {
	        _this5.userMangerMotion.push({ manger: newMotionManager.motion, callBack: resolve });
	      }
	    });
	  } else {
	    motionManger.startMotionPrio(motion, priority);
	...
	var CreateScene = function () {
	  ...
	  _createClass(CreateScene, [{
	    ...
	    value: function draw() {
	      ...
	      this.user_model.forEach(function (val) {
	        var classModel = val.model;
	    ...
	    value: function modelName(name, model) {
	      ...
	      if (this.user_model.some(function (val, index) {
	        if (name === val.name) {
	          _this2.user_model[index].model = model;
	          return true;
	        }
	      })) {
	        return;
	      }
	      this.user_model.push({ name: name || 'default', model: model });
	    }
	    /**
	     * @param {String} name - 添加的模型名字,不可用纯数字命名
	    ...
	    value: function addModel() {
	      var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          ...
	          _ref2$configUrl = _ref2.configUrl,
	          configUrl = _ref2$configUrl === undefined ? '' : _ref2$configUrl;
	    ...
	    value: function loadModel() {
	      var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          ...
	          _ref3$configUrl = _ref3.configUrl,
	          configUrl = _ref3$configUrl === undefined ? '' : _ref3$configUrl;
	    ...
	    value: function getModel(name) {
	      ...
	      this.user_model.some(function (val, index) {
	        if (val.name === name) {
	          modelClass = val.model;
	          return true;
	        }
	      });
	      return modelClass;
	    ...
	    value: function setPosition() {
	      var _ref4 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          ...
	          name = _ref4$name === undefined ? '宠物的名字' : _ref4$name,
	          _ref4$postion = _ref4.postion,
	          postion = _ref4$postion === undefined ? 1 : _ref4$postion;

	      if (this.user_model.length < postion || this.user_model.length === 1) {
	        return;
	      }
	      ...
	      if (this.user_model.some(function (val, index) {
	        ...
	        val1 = this.user_model[deleteIndex];
	        this.user_model.splice(deleteIndex, 1);
	        this.user_model.splice(postion - 1, 0, val1);
	      }
	    }
	  }, {
	    key: 'removeModel',
	    value: function removeModel(name) {
	      ...
	      if (this.user_model.some(function (val, index) {
	        ...
	        this.live2DMgr.userDelete(this.user_model[deleteIndex].model.model, this.gl);
	        delete this.user_model[deleteIndex];
	        this.user_model.splice(deleteIndex, 1);
	      }
	    }
	  }, {
	    key: 'removeAllModel',
	    value: function removeAllModel() {
	      var _this3 = this;

	      this.user_model.forEach(function (val, index) {
	        _this3.live2DMgr.userDelete(val.model.model, _this3.gl);
	        delete _this3.user_model[index];
	      });
	      this.user_model = [];
	    }
	  }, {
	    ...
	    value: function move() {
	      ...
	      return new _Promise(function (resolve, reject) {
	        if (_this4.getIsAnimation(resolve, 'none')) {
	          return;
	        }
	        if (_this4.getIsMove(x, y)) {
	          resolve('没有移动');
	          return;
	        }
	        _this4.userAppearAnimation = true;
	        _this4.moveDom.style.transition = 'all ' + time + ' linear';
	        _this4.setCanvasStyle({ left: x + 'px', top: y + 'px' });
	        var fn = function fn(e) {
	          _this4.moveDom.removeEventListener('transitionend', fn);
	          _this4.setCanvasStyle({ transition: 'none' });
	          _this4.userAppearAnimation = false;
	          resolve(_this4);
	        };
	        _this4.addCanvasEvent({ event: 'transitionend', func: fn });
	      });
	    }
	  }, {
	    key: 'addCanvasEvent',
	    ...
	    value: function appear() {
	      ...
	      var _ref7 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          ...
	          _ref7$textContent = _ref7.textContent,
	          textContent = _ref7$textContent === undefined ? false : _ref7$textContent;

	      return new _Promise(function (resolve, reject) {
	        if (_this5.getIsAnimation(resolve, 'block')) {
	          return;
	        }
	        if (_this5.vm && textContent !== false) {
	          _this5.appearText({ text: textContent });
	        }
	        _this5.startUtick();
	        _this5.setCanvasStyle({ left: startX + 'px', top: startY + 'px' });
	        if (animation) {
	          _this5.userAppearAnimation = true;
	          _this5.setCanvasStyle({ opacity: startOpacity, transition: 'all ' + time + ' linear', display: 'block' });
	          _this5.getChongHui('opacity', _this5.moveDom);
	          _this5.setCanvasStyle({ opacity: 1, left: endX + 'px', top: endY + 'px' });
	          var fn = function fn() {
	            _this5.moveDom.removeEventListener('transitionend', fn);
	            _this5.setCanvasStyle({ transition: 'none' });
	            _this5.userAppearAnimation = false;
	            resolve(_this5);
	          };
	          _this5.moveDom.addEventListener('transitionend', fn);
	        } else {
	          _this5.setCanvasStyle({ display: 'block', opacity: 1 });
	          resolve(_this5);
	        }
	      });
	    }
	    ...
	    value: function setCanvasStyle(objStyle) {
	      ...
	      _Object$entries(objStyle).forEach(function (_ref8) {
	        ...
	        _this6.moveDom.style[key] = value;
	      });
	    }
	  }, {
	    key: 'disappear',
	    value: function disappear() {
	      ...
	      return new _Promise(function (resolve, reject) {
	        if (_this7.getIsAnimation(resolve, 'none')) {
	          return;
	        }
	        _this7.stopUtick();
	        if (animation) {
	          _this7.userAppearAnimation = true;
	          _this7.setCanvasStyle({ transition: 'all ' + time + ' linear', opacity: opacity });
	          var fn = function fn() {
	            _this7.moveDom.removeEventListener('transitionend', fn);
	            _this7.setCanvasStyle({ display: 'none', transition: 'none' });
	            _this7.userAppearAnimation = false;
	            resolve(_this7);
	          };
	          _this7.moveDom.addEventListener('transitionend', fn);
	        } else {
	          _this7.setCanvasStyle({ display: 'none', opacity: opacity });
	          resolve(_this7);
	        }
	      });
	    }
	    ...
	    value: function animation() {
	      ...
	      return new _Promise(function (resolve, reject) {
	        if (_this8.getIsAnimation(resolve, 'none')) {
	          return;
	        }
	        _this8.userAppearAnimation = true;
	        var obj = {};
	        ...
	        _this8.setCanvasStyle({ transition: 'all ' + time + ' linear' });
	        for (var k in obj) {
	          if (k === 'time') {
	            break;
	          }
	          if (k === 'opacity') {
	            _this8.moveDom.style[k] = obj[k];
	            break;
	          }
	          _this8.moveDom.style[k] = obj[k] + 'px';
	        }
	        var fn = function fn() {
	          _this8.moveDom.removeEventListener('transitionend', fn);
	          _this8.setCanvasStyle({ transition: 'none' });
	          _this8.userAppearAnimation = false;
	          resolve(_this8);
	        };
	        _this8.moveDom.addEventListener('transitionend', fn);
	      });
	    }
	  }]);
	  ...
	  _createClass(Model, [{
	    ...
	    value: function startMotion() {
	      ...
	      var _ref14 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          ...
	          _ref14$soundUrl = _ref14.soundUrl,
	          soundUrl = _ref14$soundUrl === undefined ? false : _ref14$soundUrl,
	          _ref14$newMotion = _ref14.newMotion,
	          newMotion = _ref14$newMotion === undefined ? false : _ref14$newMotion;
	      ...
	      return new _Promise(function (resolve, reject) {
	        _this9.model.startMotion(name, id, undefined, resolve, newMotion);
	      });
	    }
	  }, {
	    key: 'stopMotion',
	    ...
	    value: function startExpress() {
	      ...
	      var _ref16 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          ...
	          name = _ref16$name === undefined ? 'expressName' : _ref16$name;

	      // this.model.setExpression(name, callBack)
	      return new _Promise(function (resolve, reject) {
	        _this10.model.setExpression(name, resolve);
	      });
	    }
	  }, {
	    key: 'stopExpress',
	    ...
	    value: function startPose() {
	      ...
	      var _ref17 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          _ref17$pose = _ref17.pose,
	          pose = _ref17$pose === undefined ? '' : _ref17$pose;

	      var url = this.baseUrl + '/' + pose;
	      return new _Promise(function (resolve, reject) {
	        _this11.model.userStartPoseOption(url, resolve);
	      });
	    }
	  }, {
	    key: 'scaleMoving',
	    value: function scaleMoving(type, resolve) {
	      ...
	      scaleId = setInterval(function () {
	        _this12.CreateScene.modelScaling(num);
	        if (_this12.CreateScene.isUserMaxScale || _this12.CreateScene.isUserMinScale) {
	          _this12.CreateScene.isUserMaxScale = false;
	          _this12.CreateScene.isUserMinScale = false;
	          _this12.isScale = false;
	    ...
	    value: function scale() {
	      ...
	      var _ref18 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          ...
	          _scale = _ref18$scale === undefined ? 1 : _ref18$scale;
	      ...
	      return new _Promise(function (resolve, reject) {
	        ...
	        var viewMatrix = _this13.CreateScene.viewMatrix;
	        ...
	        if (viewMatrix.getCurrentScale() < _scale) {
	          ...
	          _this13.scaleMoving(true, resolve);
	        } else {
	          viewMatrix.setMinScale(_scale);
	          _this13.scaleMoving(false, resolve);
	        }
	      });
	    }
	  }, {
	    ...
	    value: function replacePart() {
	      ...
	      var _ref19 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          _ref19$picArr = _ref19.picArr,
	          picArr = _ref19$picArr === undefined ? [] : _ref19$picArr,
	          _ref19$load = _ref19.load,
	          load = _ref19$load === undefined ? false : _ref19$load;

	      return new _Promise(function (resolve, reject) {
	        if (load === true) {
	          _this14.json.textures = picArr;
	          _this14.CreateScene.live2DMgr.userPlacePart(_this14, _this14.CreateScene.gl, _this14, _this14.loadUrl, resolve);
	        } else {
	          _this14.json.textures = picArr;
	          _this14.model.userGetChangeClothes(_this14.CreateScene.gl, resolve, _this14);
	        }
	      });
	    }
	    /**
	    ...
	    key: 'startSound',
	    value: function startSound(callBack) {
	      var _this15 = this;
	      ...
	      this.audio.addEventListener('canplaythrough', function () {
	        _this15.audio.play();
	        if (isFunction_1(callBack)) callBack();
	      });
	    ...
	    value: function animations() {
	      ...
	      var _ref20 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          _ref20$soundUrl = _ref20.soundUrl,
	          soundUrl = _ref20$soundUrl === undefined ? false : _ref20$soundUrl,
	          _ref20$textObj = _ref20.textObj,
	          textObj = _ref20$textObj === undefined ? false : _ref20$textObj,
	          _ref20$pose = _ref20.pose,
	          _ref20$scale = _ref20.scale,
	          _ref20$startExpress = _ref20.startExpress,
	          _ref20$startMotion = _ref20.startMotion;

	      var obj = {};
	      var arr = [];
	      _Object$entries(arguments[0]).forEach(function (_ref21) {
	      ...
	      _Object$entries(obj).forEach(function (_ref23) {
	        ...
	        switch (key) {
	          case 'scale':
	            arr.push(_this16.scale({ scale: value }));
	            break;
	          case 'startExpress':
	            arr.push(_this16.startExpress({ name: value }));
	            break;
	          case 'startMotion':
	            arr.push(_this16.startMotion(value));
	            break;
	          case 'pose':
	            arr.push(_this16.startPose({ pose: value }));
	            break;
	          case 'textObj':
	            if (value === 'close') {
	              _this16.CreateScene.disAppearText({ animation: true });
	              break;
	            }
	            arr.push(_this16.CreateScene.changeText(textObj));
	            break;
	        }
	      });
	    ...
	    /**
	     * @description 传入N组执行动画的参数组成数组执行动画，上一组动画参数执行完 执行下一组
	     * @param {Array} animationArray - 执行动画的一组参数
	     */

	  }, {
	    key: 'carryAnimations',
	    value: function carryAnimations(animationArray, Func) {
	      var _this17 = this;

	      // this.AnimationArrayIndex
	      if (!isArray_1(animationArray)) {
	        console.error('参数不正确');
	        return;
	      }
	      if (this.isAnimationArrayEnd === true) {
	        if (!isFunction_1(Func)) {
	          this.isAnimationArrayEnd = false;
	        } else {
	          this.isAnimationArrayEnd = false;
	          Func();
	          return;
	      ...
	      if (isArray_1(animationArray) && animationArray.length === 0) {
	        if (Func) {
	          Func();
	        }
	        return;
	      ...
	      if (isFunction_1(Func)) {
	        return this.animations(animationArray[0]).then(function () {
	          _this17.carryAnimations(animationArray.slice(1), Func);
	        });
	      }
	      return new _Promise(function (resolve, reject) {
	        _this17.animations(animationArray[0]).then(function () {
	          _this17.carryAnimations(animationArray.slice(1), resolve);
	        });
	      });
	    }
	  }, {
	    key: 'carryAnimationsEnd',
	    value: function carryAnimationsEnd() {
	      var _this18 = this;

	      return new _Promise(function (resolve, reject) {
	        _this18.isAnimationArrayEnd = true;
	        _this18.stopMotion(resolve);
	        _this18.CreateScene.disAppearText();
	      });
	    }
	  }, {
	    ...
	    value: function replaceRandomMotion() {
	      var _ref25 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          ...
	          name = _ref25$name === undefined ? '' : _ref25$name;
	    ...
	    value: function mouseSpeak() {
	      ...
	      var _ref26 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          _ref26$soundUrl = _ref26.soundUrl,
	          soundUrl = _ref26$soundUrl === undefined ? false : _ref26$soundUrl,
	          _ref26$mouseSpeed = _ref26.mouseSpeed,
	          mouseSpeed = _ref26$mouseSpeed === undefined ? 5 : _ref26$mouseSpeed,
	          _ref26$text = _ref26.text,
	          text = _ref26$text === undefined ? false : _ref26$text,
	          _ref26$animation = _ref26.animation,
	          animation = _ref26$animation === undefined ? false : _ref26$animation,
	          _ref26$textStayTime = _ref26.textStayTime,
	          textStayTime = _ref26$textStayTime === undefined ? false : _ref26$textStayTime;
	      ...
	      return new _Promise(function (resolve, reject) {
	        ...
	        if (_this19.isMouseSpeaking) {
	          reject(new Error('  正在mouseSpeaking，可停止'));
	          return;
	        }
	        if (_this19.CreateScene.vm && text !== false) {
	          _this19.isStopSpeakText = true;
	          _this19.TextStayTime = textStayTime;
	          _this19.CreateScene.changeText({ text: text, animation: animation });
	        }
	        _this19.isMouseSpeaking = true;
	        _this19.mouseSpeed = mouseSpeed;
	        _this19.mouseSpeedMark = -1;
	        ...
	        _this19.ownSoundUrl = soundUrl;
	        _this19.speakMouseResolve = resolve;
	        _this19.startSound();
	        _this19.animations(arg);
	        _this19.userMouseArray = result;
	      });
	    }
	  }, {
	    ...
	    value: function mouseSpeakMotion() {
	      ...
	      var _ref27 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	          _ref27$motion = _ref27.motion,
	          motion = _ref27$motion === undefined ? false : _ref27$motion,
	      ...
	      return new _Promise(function (resolve, reject) {
	        ...
	        if (_this20.isMouseSpeaking) {
	          reject(new Error('  正在mouseSpeaking，可停止'));
	          return;
	        }
	        if (_this20.CreateScene.vm && text !== false) {
	          _this20.isStopSpeakText = true;
	          _this20.TextStayTime = textStayTime;
	          _this20.CreateScene.changeText({ text: text, animation: animation });
	        }
	        _this20.speakMouseResolve = resolve;
	        _this20.startMotion(motion);
	      });
	    }
	  }, {
	    key: 'stopSpeak',
	...
	var VmApi = {
	  ...
	  changeText: function changeText() {
	    ...
	    var _ref28 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	        ...
	        text = _ref28$text === undefined ? 'hahha' : _ref28$text,
	        _ref28$style = _ref28.style,
	    ...
	    return new _Promise(function (resolve, reject) {
	      if (animation === true) {
	        _this21.disAppearText({ animation: animation }).then(function () {
	          if (_Object$keys(style).length) {
	            _this21.changeTextStyle(style).then(function () {
	              _this21.appearText({ animation: animation, text: text }).then(function () {
	                resolve(_this21);
	              });
	            });
	          } else {
	      ...
	      if (_Object$keys(style).length) {
	        _this21.changeTextStyle(style);
	      }

	      _this21.domInnerText(text);
	      _this21.divText.style.opacity = 1;
	      _this21.divText.style.display = 'block';
	      resolve(_this21);
	    });
	  },
	  changeTextStyle: function changeTextStyle() {
	    ...
	    var _ref29 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	        ...
	        _ref29$fontSize = _ref29.fontSize,
	        _ref29$opacity = _ref29.opacity,
	        _ref29$background = _ref29.background,
	        _ref29$backgroundColo = _ref29.backgroundColor;

	    return new _Promise(function (resolve, reject) {
	      var objStyle = {};
	      _Object$entries(_arguments2[0]).forEach(function (_ref30) {
	      ...
	      _Object$entries(objStyle).forEach(function (_ref32) {
	        var _ref33 = _slicedToArray(_ref32, 2),
	            property = _ref33[0],
	            val = _ref33[1];

	        _this22.divText.style[property] = val;
	      });
	      resolve(_this22);
	    });
	  },
	  appearText: function appearText() {
	    ...
	    var _ref34 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	        _ref34$time = _ref34.time,
	        time = _ref34$time === undefined ? '500ms' : _ref34$time,
	        _ref34$animation = _ref34.animation,
	        animation = _ref34$animation === undefined ? false : _ref34$animation,
	        _ref34$text = _ref34.text,
	        text = _ref34$text === undefined ? false : _ref34$text;

	    return new _Promise(function (resolve, reject) {
	      if (_this23.getDivTextStatus('block')) {
	        resolve(_this23);
	        return;
	      }
	      if (text !== false) {
	        _this23.domInnerText(text);
	      }
	      if (animation === true) {
	        _this23.divText.style.transition = 'all ' + time;
	        _this23.divText.style.display = 'block';
	        _this23.getChongHui('opacity', _this23.divText);
	        _this23.divText.style.opacity = 1;
	        var fn = function fn(e) {
	          e.stopPropagation();
	          _this23.divText.removeEventListener('transitionend', fn);
	          _this23.divText.style.transition = 'none';
	          resolve(_this23);
	        };
	        _this23.divText.addEventListener('transitionend', fn);
	      } else {
	        _this23.divText.style.opacity = 1;
	        _this23.divText.style.display = 'block';
	        resolve(_this23);
	  ...
	  disAppearText: function disAppearText() {
	    ...
	    return new _Promise(function (resolve, reject) {
	      if (_this24.getDivTextStatus('none')) {
	        resolve(_this24);
	        return;
	      }
	      if (animation === true) {
	        _this24.divText.style.transition = 'all ' + time;
	        _this24.divText.style.opacity = 0;
	        var fn = function fn(e) {
	          e.stopPropagation();
	          _this24.divText.style.display = 'none';
	          _this24.divText.removeEventListener('transitionend', fn);
	          _this24.divText.style.transition = 'none';
	          resolve(_this24);
	        };
	        _this24.divText.addEventListener('transitionend', fn);
	      } else {
	        _this24.divText.style.opacity = 0;
	        _this24.divText.style.display = 'none';
	        resolve(_this24);
	      ...
	      Vue.mixin({
	        mounted: function mounted() {
	          if (this.$root === this) {
	            ...
	            var mo = new FindLive2D.CreateScene(_extends$1({ vm: vm, isVue: true }, DOMID));
	            ...
	            Vue.$FindLive2d = mo;
	            // this.$root.$Live2d = new FindLive2D.CreateScene({ vm: vm, isVue: true, ...DOMID })
	          }
	        }
	      });
